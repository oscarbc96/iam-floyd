...
export class Imagebuilder extends PolicyStatement {
   ...
   * @param op Operator of the condition. Works with [string operators](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_condition_operators.html#Conditions_String). **Default:** `StringLike`
   */
  public ifCreatedResourceTag(key: string, value: string | string[], op?: string) {
    return this.if(`imagebuilder:CreatedResourceTag/${ key }`, value, op || 'StringLike');
  }
   ...
   * @param op Operator of the condition. Works with [string operators](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_condition_operators.html#Conditions_String). **Default:** `StringLike`
   */
  public ifCreatedResourceTagKeys(value: string | string[], op?: string) {
    return this.if(`imagebuilder:CreatedResourceTagKeys`, value, op || 'StringLike');
  }
}
