...
export class Health extends PolicyStatement {
   ...
   */
  public ifEventTypeCode(value: string | string[], op?: string) {
    return this.if(`health:eventTypeCode`, value, op || 'StringLike');
  }
  ...
  public ifService(value: string | string[], op?: string) {
    return this.if(`health:service`, value, op || 'StringLike');
  }
}
