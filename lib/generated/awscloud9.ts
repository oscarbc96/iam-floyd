...
export class Cloud9 extends PolicyStatement {
   ...
   * @param op Operator of the condition. Works with [string operators](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_condition_operators.html#Conditions_String). **Default:** `StringLike`
   */
  public ifEnvironmentId(value: string | string[], op?: string) {
    return this.if(`cloud9:EnvironmentId`, value, op || 'StringLike');
  }
   ...
   * @param op Operator of the condition. Works with [string operators](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_condition_operators.html#Conditions_String). **Default:** `StringLike`
   */
  public ifEnvironmentName(value: string | string[], op?: string) {
    return this.if(`cloud9:EnvironmentName`, value, op || 'StringLike');
  }
  ...
  public ifInstanceType(value: string | string[], op?: string) {
    return this.if(`cloud9:InstanceType`, value, op || 'StringLike');
  }
   ...
   * @param op Operator of the condition. Works with [string operators](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_condition_operators.html#Conditions_String). **Default:** `StringLike`
   */
  public ifPermissions(value: string | string[], op?: string) {
    return this.if(`cloud9:Permissions`, value, op || 'StringLike');
  }
   ...
   * @param op Operator of the condition. Works with [string operators](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_condition_operators.html#Conditions_String). **Default:** `StringLike`
   */
  public ifSubnetId(value: string | string[], op?: string) {
    return this.if(`cloud9:SubnetId`, value, op || 'StringLike');
  }
   ...
   */
  public ifUserArn(value: string | string[], op?: string) {
    return this.if(`cloud9:UserArn`, value, op || 'ArnEquals');
  }
}
