...
export class Iot extends PolicyStatement {
   ...
   * @param op Operator of the condition. Works with [string operators](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_condition_operators.html#Conditions_String). **Default:** `StringLike`
   */
  public ifThingGroupArn(value: string | string[], op?: string) {
    return this.if(`iot:ThingGroupArn`, value, op || 'StringLike');
  }
   ...
   * @param op Operator of the condition. Works with [string operators](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_condition_operators.html#Conditions_String). **Default:** `StringLike`
   */
  public ifTunnelDestinationService(value: string | string[], op?: string) {
    return this.if(`iot:TunnelDestinationService`, value, op || 'StringLike');
  }
}
